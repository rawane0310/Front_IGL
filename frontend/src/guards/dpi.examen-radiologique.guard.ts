...
/**
 * Guard function that restricts access to the "DPI Examen Radiologique" section 
 * based on the user's role.
 * 
 * This guard allows access if the user has the role of 'radiologue' (radiologist), 
 * 'medecin' (doctor), or 'patient'. If the user does not have one of these roles, 
 * access is denied and a warning is displayed.
 * 
 * @guard
 * 
